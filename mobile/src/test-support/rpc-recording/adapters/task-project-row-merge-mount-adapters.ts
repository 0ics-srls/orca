...
/**
 * A board row's file list and the merge it shares a screen with, plus the issue and pull-request
 * state writes that hook exposes alongside them.
 */
export function taskProjectRowMergeMountAdapters(
