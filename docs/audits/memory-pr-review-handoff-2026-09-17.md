...
**Historical snapshot.** The later [59-PR correctness and merge-risk review](./memory-pr-risk-review-2026-09-17.md) supersedes these recommendations, withdraws two PRs, and records corrected heads and explicit user-facing tradeoffs. Counts and CI below describe the earlier handoff only.
