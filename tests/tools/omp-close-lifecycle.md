...
model turn, initialized eval workers or LSPs, Windows/WSL/Linux execution, or daemon
and SSH ownership. Daemon/remote keep-alive is intentional and remains unchanged.
