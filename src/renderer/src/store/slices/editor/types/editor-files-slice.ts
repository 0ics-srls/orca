...
export type EditorFilesSlice = {
  ...
  /** targetWorktreeId scopes the activation: global selection only moves when it names the
   *  globally active workspace (mirrors setActiveTabType). Omitted keeps legacy global writes. */
