 ...
 */
export function tableExists(db: SyncDatabase, tableName: string): boolean {
  const row = db
 ...
 */
export function columnExists(db: SyncDatabase, tableName: string, columnName: string): boolean {
